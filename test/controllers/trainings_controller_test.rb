...
class TrainingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create training" do
    assert_difference("Training.count") do
      post trainings_url, params: { training: { repeticoes: @training.repeticoes, serie_treino: @training.serie_treino, student_id: @training.student_id, tipo_treino: @training.tipo_treino } }
    end
  ...
  test "should update training" do
    patch training_url(@training), params: { training: { repeticoes: @training.repeticoes, serie_treino: @training.serie_treino, student_id: @training.student_id, tipo_treino: @training.tipo_treino } }
