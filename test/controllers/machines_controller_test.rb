...
class MachinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create machine" do
    assert_difference("Machine.count") do
      post machines_url, params: { machine: { gym_id: @machine.gym_id, nome_maquina: @machine.nome_maquina, quan_maquina: @machine.quan_maquina, tipo_maquina: @machine.tipo_maquina } }
    end
  ...
  test "should update machine" do
    patch machine_url(@machine), params: { machine: { gym_id: @machine.gym_id, nome_maquina: @machine.nome_maquina, quan_maquina: @machine.quan_maquina, tipo_maquina: @machine.tipo_maquina } }
